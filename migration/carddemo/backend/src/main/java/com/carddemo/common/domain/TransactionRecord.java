...
/**
 * TRANSACT VSAM KSDS record CVTRA05Y TRAN-RECORD (RECLN 350).
 * TRAN-ID is the zero-padded 16-char numeric key ({@code id}), preserving VSAM
 * key ordering under lexicographic sorts.
 */
@Entity
@Table(name = "transactions", indexes = @Index(name = "idx_transactions_card", columnList = "card_num"))
