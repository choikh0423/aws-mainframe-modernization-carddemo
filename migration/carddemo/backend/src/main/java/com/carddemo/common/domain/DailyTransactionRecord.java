...
/**
 * DALYTRAN sequential file record CVTRA06Y DALYTRAN-RECORD (RECLN 350).
 */
@Entity
@Table(name = "daily_transactions", indexes = @Index(name = "idx_daily_transactions_card", columnList = "card_num"))
