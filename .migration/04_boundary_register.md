...
| B-09 | IMPLEMENTED | 2026-09-09 | `auth_fraud` table plus `com.carddemo.pendingauth` repositories. **Audit findings A-01/A-02/A-03/A-08 corrected the column types against `AUTHFRDS.ddl`/DCLGEN** in `V900__auth_fraud_column_types.sql` (PR #59, merged 2026-09-09), which closes this row. |
